			...
			<Accordion>
				...
				<AccordionDetails>
					<Typography>
						...
						huge uphill battle against the algorithms that be. Arbor solves this by connecting artists directly with the
						fans and collectors that enjoy their music while simultaneously getting paid in full for the value that
						their art holds via cryptocurrencies. This means of decentralization alleviates all barriers that come with
						trying to launch a new track on a big music streaming platform. Not only does Arbor provide this for a
						single artist releasing their own track, but it adds to that by allowing multiple artists to co-create a
						single track where all of them benefit from these features.
					</Typography>
				</AccordionDetails>
			</Accordion>
			<Accordion>
				...
				<AccordionDetails>
					<Typography>
						...
						while often not reaching many listeners due to the algorithms that are out of an artist&apos;s control. The
						idea for Arbor is driven by these pain points that have been experienced first hand, and hope to bring a fun
						and unique user experience for both artists and collectors while being backed by the security of the
