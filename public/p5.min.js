...
!(function (n) {
	...
	function (t, e, n) {
		...
		void 0 ===
			(i = function () {
				'use strict'
				function l(t, e) {
					this.isUndef(t) || 1 === t ? (this.input = this.context.createGain()) : 1 < t && (this.input = new Array(t)),
						this.isUndef(e) || 1 === e
				...
				return (
					(l.prototype.set = function (t, e, n) {
						...
						t: for (var r in t) {
							...
							var c = o[r]
							this.isUndef(c) ||
								((l.Signal && c instanceof l.Signal) || (l.Param && c instanceof l.Param)
									? c.value !== e && (this.isUndef(n) ? (c.value = e) : c.rampTo(e, n))
					...
					(l.prototype._collectDefaults = function (t) {
						...
						if ((this.isUndef(t.defaults) || (e = Object.keys(t.defaults)), !this.isUndef(t._super)))
							for (var n = this._collectDefaults(t._super), i = 0; i < n.length; i++)
					...
					(l.prototype.dispose = function () {
						return (
							this.isUndef(this.input) ||
								(this.input instanceof AudioNode && this.input.disconnect(), (this.input = null)),
							this.isUndef(this.output) ||
								(this.output instanceof AudioNode && this.output.disconnect(), (this.output = null)),
							this
						)
					}),
					...
					(l.State = { Started: 'started', Stopped: 'stopped', Paused: 'paused' }),
				...
				(r = function (e) {
					...
					return (
						...
						(e.Multiply.prototype.dispose = function () {
							return (
								e.prototype.dispose.call(this), this._mult.dispose(), (this._mult = null), (this._param = null), this
							)
						}),
						e.Multiply
					)
			...
			void 0 ===
				(r = function (e) {
					...
					return (
						...
						(e.Signal.defaults = { value: 0, units: e.Type.Default, convert: !0 }),
			...
			void 0 ===
				(r = function (e) {
					...
					return (
						(e.Add = function (t) {
							this.createInsOuts(2, 0),
								(this._sum = this.input[0] = this.input[1] = this.output = new e.Gain()),
					...
					return (
						...
						(u.TimelineSignal.prototype.setValueAtTime = function (t, e) {
							return (
								(t = this._fromUnits(t)),
								(e = this.toSeconds(e)),
								this._events.add({ type: u.TimelineSignal.Type.Set, value: t, time: e }),
						...
						(u.TimelineSignal.prototype.linearRampToValueAtTime = function (t, e) {
							return (
								(t = this._fromUnits(t)),
								(e = this.toSeconds(e)),
								this._events.add({ type: u.TimelineSignal.Type.Linear, value: t, time: e }),
						...
						(u.TimelineSignal.prototype.exponentialRampToValueAtTime = function (t, e) {
							...
							return (
								this._events.add({ type: u.TimelineSignal.Type.Exponential, value: i, time: e }),
								t < this._minOutput
									? (this._param.exponentialRampToValueAtTime(this._minOutput, e - this.sampleTime),
						...
						(u.TimelineSignal.prototype.setTargetAtTime = function (t, e, n) {
							return (
								...
								(e = this.toSeconds(e)),
								this._events.add({ type: u.TimelineSignal.Type.Target, value: t, time: e, constant: n }),
						...
						(u.TimelineSignal.prototype.setValueCurveAtTime = function (t, e, n, i) {
							...
							;(e = this.toSeconds(e)),
								(n = this.toSeconds(n)),
								this._events.add({ type: u.TimelineSignal.Type.Curve, value: r, time: e, duration: n }),
						...
						(u.TimelineSignal.prototype.setRampPoint = function (t) {
							...
							if (n && n.time === t) this.cancelScheduledValues(t + this.sampleTime)
							else if (n && n.type === u.TimelineSignal.Type.Curve && n.time + n.duration > t)
								this.cancelScheduledValues(t), this.linearRampToValueAtTime(e, t)
							else {
								...
								i &&
									...
									i.type === u.TimelineSignal.Type.Linear
										...
										: i.type === u.TimelineSignal.Type.Exponential && this.exponentialRampToValueAtTime(e, t)),
						...
						(u.TimelineSignal.prototype.getValueAtTime = function (t) {
							...
							if (null === n) i = this._initial
								...
								;(r = null === o ? this._initial : o.value),
									(i = this._exponentialApproach(n.time, r, n.value, n.constant, t))
							} else
								i =
									n.type === u.TimelineSignal.Type.Curve
										...
										? this._linearInterpolate(n.time, n.value, e.time, e.value, t)
										: e.type === u.TimelineSignal.Type.Exponential
										? this._exponentialInterpolate(n.time, n.value, e.time, e.value, t)
										: n.value
							return i
						}),
						(u.TimelineSignal.prototype.connect = u.SignalBase.prototype.connect),
						(u.TimelineSignal.prototype._exponentialApproach = function (t, e, n, i, r) {
				...
				(r = function (n) {
					...
					return (
						...
						(n.prototype.createInsOuts = function (t, e) {
							1 === t ? (this.input = new n.Gain()) : 1 < t && (this.input = new Array(t)),
								1 === e ? (this.output = new n.Gain()) : 1 < e && (this.output = new Array(t))
						}),
						n.Gain
					)
				}.apply(e, i)) || (t.exports = r)
					...
					return (
						(r.Clock = function () {
							...
							;(this.callback = t.callback),
								...
								(this.frequency = new r.TimelineSignal(t.frequency, r.Type.Frequency)),
						...
						(r.Clock.defaults = { callback: r.noOp, frequency: 1, lookAhead: 'auto' }),
						...
						(r.Clock.prototype.start = function (t, e) {
							return (
								...
								this._state.getValueAtTime(t) !== r.State.Started &&
									this._state.add({ state: r.State.Started, time: t, offset: e }),
								this
							)
						}),
						(r.Clock.prototype.stop = function (t) {
							return (
								(t = this.toSeconds(t)), this._state.cancel(t), this._state.setStateAtTime(r.State.Stopped, t), this
							)
						}),
						(r.Clock.prototype.pause = function (t) {
							return (
								(t = this.toSeconds(t)),
								this._state.getValueAtTime(t) === r.State.Started && this._state.setStateAtTime(r.State.Paused, t),
								this
							)
						}),
						(r.Clock.prototype._loop = function () {
							for (
								var t = this.now() + this.context.lookAhead + this.context.updateInterval + 2 * this.context.lag;
				...
				(r = function (i) {
					...
					return (
						...
						(i.Context.prototype.getConstant = function (t) {
							...
							for (
								var e = this._context.createBuffer(1, 128, this._context.sampleRate), n = e.getChannelData(0), i = 0;
								i < n.length;
								i++
							)
								n[i] = t
							...
							AudioNode.prototype.connect !== t &&
								...
								(AudioNode.prototype.disconnect = function (t, e, n) {
									if (t && t.input && Array.isArray(t.input))
										i.prototype.isUndef(n) && (n = 0), this.disconnect(t.input[n], e, n)
						...
						(i.SignalBase.prototype.connect = function (t, e, n) {
							return (
								...
								(i.TimelineSignal && i.TimelineSignal === t.constructor)
									? (t._param.cancelScheduledValues(0), (t._param.value = 0), (t.overridden = !0))
									: t instanceof AudioParam && (t.cancelScheduledValues(0), (t.value = 0)),
			...
			void 0 ===
				(r = function (n) {
					return (
						...
						(n.Time.prototype._unaryExpressions = Object.create(n.TimeBase.prototype._unaryExpressions)),
			...
			void 0 ===
				(r = function (i) {
					return (
						...
						(i.TimeBase.prototype._primaryExpressions = {
							...
							tr: {
								...
								method: function (t, e, n) {
									var i = 0
									return (
										t && '0' !== t && (i += this._beatsToUnits(this._timeSignature() * parseFloat(t))),
						...
						(i.TimeBase.prototype._syntaxGlue = { '(': { regexp: /^\(/ }, ')': { regexp: /^\)/ } }),
						(i.TimeBase.prototype._tokenize = function (t) {
							...
							function r(t, e) {
								for (
									var n = ['_binaryExpressions', '_unaryExpressions', '_primaryExpressions', '_syntaxGlue'], i = 0;
									i < n.length;
									i++
								) {
									var r = e[n[i]]
									for (var o in r) {
										var s = r[o],
											a = s.regexp,
											u = t.match(a)
										if (null !== u) return { method: s.method, precedence: s.precedence, regexp: s.regexp, value: u[0] }
									}
								}
						...
						(i.TimeBase.prototype._parseBinary = function (t, e) {
							...
							for (var i = t.peek(); i && this._matchGroup(i, this._binaryExpressions, e); )
								(n = (i = t.next()).method.bind(this, n, this._parseBinary(t, e - 1))), (i = t.peek())
							return n
						}),
						...
						(i.TimeBase.prototype._parsePrimary = function (t) {
							...
							if (e && '(' === e.value) {
								if ((t.next(), (n = this._parseBinary(t)), !(e = t.next()) || ')' !== e.value))
						...
						(i.TimeBase.prototype._pushExpr = function (t, e, n) {
							return (
								...
								(this._expr = this._binaryExpressions[e].method.bind(this, this._expr, t._expr)),
								this
							)
						}),
					...
					return (
						(i.Param = function () {
							...
							;(this._param = this.input = t.param),
								...
								(this.overridden = !1),
								(this._lfo = null),
								this.isObject(t.lfo) ? (this.value = t.lfo) : this.isUndef(t.value) || (this.value = t.value)
						}),
						i.extend(i.Param),
						(i.Param.defaults = { units: i.Type.Default, convert: !0, param: void 0 }),
						...
						(i.Param.prototype.rampTo = function (t, e, n) {
							return (
								...
								this.units === i.Type.Frequency || this.units === i.Type.BPM || this.units === i.Type.Decibels
					...
					return (
						(e.CrossFade = function (t) {
							this.createInsOuts(2, 1),
								...
								(this.fade = new e.Signal(this.defaultArg(t, 0.5), e.Type.NormalRange)),
			...
			void 0 ===
				(r = function (r) {
					;(r.Frequency = function (t, e) {
						...
						(r.Frequency.prototype._primaryExpressions = Object.create(r.TimeBase.prototype._primaryExpressions)),
			...
			void 0 ===
				(r = function (i) {
					return (
						...
						(i.TransportTime.prototype._unaryExpressions = Object.create(i.Time.prototype._unaryExpressions)),
	...
	function (t, e, n) {
		var i, r
		;(i = [n(0), n(4), n(13), n(1), n(33), n(21), n(34), n(20), n(35), n(36), n(37)]),
			void 0 ===
				(r = function (u) {
					'use strict'
					function n(t, e, n) {
					...
					return (
						...
						(u.Expr._Expressions = {
							...
							binary: {
								'+': { regexp: /^\+/, precedence: 1, method: n.bind(this, u.Add) },
								'-': {
									regexp: /^\-/,
									precedence: 1,
									method: function (t, e) {
								...
								'*': { regexp: /^\*/, precedence: 0, method: n.bind(this, u.Multiply) },
							},
							unary: {
								...
								for (var e in u.Expr._Expressions) {
									...
									for (var i in n) {
										var r = n[i],
											o = r.regexp,
											s = t.match(o)
										if (null !== s) return { type: e, value: s[0], method: r.method }
									}
								}
						...
						(u.Expr.prototype._parseTree = function (t) {
							...
							function a(t) {
										...
										t < 0
											? (function t() {
													...
													return o((e = i.peek()), 'unary')
														? ((e = i.next()), (n = t()), { operator: e.value, method: e.method, args: [n] })
														: (function () {
																var t, e
																if (((t = i.peek()), s(t)))
																...
																if ('func' === t.type)
																	return (function (t) {
																		...
																		if (
																			(r(i.peek(), ')') ||
																				(e = (function () {
																					for (var t, e = []; (t = a()), !s(t) && (e.push(t), r(i.peek(), ',')); )
																						i.next()
																					return e
																				})()),
																			r(i.next(), ')'))
																		)
																			return { method: t.method, args: e, name: name }
																		throw new SyntaxError('Tone.Expr: Expected ) in a function call "' + t.value + '"')
																	})((t = i.next()))
																if ('value' === t.type) return { method: (t = i.next()).method, args: t.value }
																if (r(t, '(')) {
																	if ((i.next(), (e = a()), !r((t = i.next()), ')')))
																		throw new SyntaxError('Expected )')
																	return e
																}
								...
								for (var n = i.peek(); o(n, 'binary', t); )
									(e = { operator: (n = i.next()).value, method: n.method, args: [e, a(t - 1)] }), (n = i.peek())
								return e
							}
							return a()
						}),
					...
					return (
						(e.Pow = function (t) {
							;(this._exp = this.defaultArg(t, 1)),
								(this._expScaler = this.input = this.output = new e.WaveShaper(this._expFunc(this._exp), 8192))
						}),
	...
	function (t, e, n) {
		...
		function h(t) {
			...
			var e = { A: 21, B: 23, C: 24, D: 26, E: 28, F: 29, G: 31 }[t[0].toUpperCase()]
		...
		function a(t) {
			var e,
				n = u((e = t.getChannelData(0)), 1 < t.numberOfChannels ? t.getChannelData(1) : e),
		...
		function u(t, e) {
			for (var n = t.length + e.length, i = new Float32Array(n), r = 0, o = 0; o < n; )
				(i[o++] = t[r]), (i[o++] = e[r]), r++
			return i
		}
		function d(t, e, n) {
					...
					return (
						w(i, [
							...
							},
							{
								...
								value: function (t) {
									1 === t
										? (this.input.disconnect(), this.input.connect(this.left), this.input.connect(this.right))
										: 2 === t &&
										  (void 0 === this.splitter && (this.splitter = S.createChannelSplitter(2)),
			...
			function o(t, e, n, i) {
				if ((O(this, o), void 0 !== t)) {
					if ('string' == typeof t || 'string' == typeof t[0]) {
						...
						this.url = r
					} else if ('object' === P(t) && !(window.File && window.FileReader && window.FileList && window.Blob))
						...
						value: function (t, e, n, i, r) {
							if (this.output) {
								...
								if (
									...
									;(r = r && (r <= this.buffer.duration - o ? r : this.buffer.duration)),
										this._paused
											? (this.bufferSourceNode.start(a, this.pauseTime, r),
											  this._counterNode.start(a, this.pauseTime, r))
											: (this.bufferSourceNode.start(a, o, r), this._counterNode.start(a, o, r)),
										(this._playing = !0),
										(this._paused = !1),
					...
					},
					{
						...
						value: function (t) {
							...
							if ('sustain' === this.mode || 'untildone' === this.mode)
								this.stopAll(e), (this._playing = !1), (this.pauseTime = 0), (this._paused = !1)
						...
						value: function (t) {
							...
							if (
								...
								this.bufferSourceNode.playbackRate.cancelScheduledValues(n),
									this.bufferSourceNode.playbackRate.linearRampToValueAtTime(Math.abs(t), n),
									this._counterNode.playbackRate.cancelScheduledValues(n),
									this._counterNode.playbackRate.linearRampToValueAtTime(Math.abs(t), n)
							}
					...
					},
					{
						...
						value: function () {
							var e = this,
								...
								r = y(256)
							return (
								n._workletNode && (n._workletNode.disconnect(), delete n._workletNode),
								(n._workletNode = new AudioWorkletNode(R, s.a.soundFileProcessor, {
								...
								(i.buffer = (function (t) {
									for (
										var e = t.length, n = R.createBuffer(1, t.length, R.sampleRate), i = n.getChannelData(0), r = 0;
										r < e;
										r++
									)
										i[r] = r
		...
		var B = (function () {
			function e(t) {
				!(function (t, e) {
					...
					(this._workletNode = new AudioWorkletNode(this.audiocontext, s.a.amplitudeProcessor, {
						outputChannelCount: [1],
						parameterData: { smoothing: t || 0 },
						processorOptions: { normalize: !1, smoothing: t || 0, numInputChannels: 2, bufferSize: this.bufferSize },
					})),
			...
			return (
				(function (t, e, n) {
					...
					},
					{
						key: 'smooth',
						value: function (t) {
							0 <= t && t < 1 && this._workletNode.port.postMessage({ name: 'smoothing', smoothing: t })
						},
					},
					{
						key: 'dispose',
				...
				return (
					(function (t, e, n) {
					...
					})(n, [
						{
							...
							value: function (t) {
								t
									? (t.output ? t.output.connect(this.analyser) : t.connect && t.connect(this.analyser),
						...
						},
						{
							...
							value: function () {
								for (var t, e, n = [], i = 0; i < arguments.length; i++)
									'number' == typeof arguments[i] && ((t = arguments[i]), (this.analyser.fftSize = 2 * t)),
							...
							value: function () {
								for (var t, e = 0; e < arguments.length; e++)
									'number' == typeof arguments[e] &&
										((this.bins = arguments[e]), (this.analyser.fftSize = 2 * this.bins)),
							...
							value: function (t, e) {
								...
								if (
									('bass' === t
										...
										: 'treble' === t && ((t = this.treble[0]), (e = this.treble[1])),
									'number' != typeof t)
								)
						...
						},
						{
							key: 'getCentroid',
							value: function () {
								for (var t = p.audiocontext.sampleRate / 2, e = 0, n = 0, i = 0; i < this.freqDomain.length; i++)
						...
						},
						{
							...
							value: function (t) {
								for (
									...
									(o[s] = void 0 !== o[s] ? (o[s] + n[a]) / 2 : n[a]), a % r == r - 1 && s++
								return o
							},
						},
						{
						...
						},
						{
							...
							value: function (t, e) {
								var n = t || 3,
									i = e || 15.625,
									r = [],
									o = { lo: i / Math.pow(2, 1 / (2 * n)), ctr: i, hi: i * Math.pow(2, 1 / (2 * n)) }
								r.push(o)
		...
		function $(t, e, n, i, r) {
			...
			for (var s in t.mathOps)
				t.mathOps[s] instanceof r &&
					(o.disconnect(), t.mathOps[s].dispose(), (n = s) < t.mathOps.length - 2 && (i = t.mathOps[s + 1]))
			return (
		...
		var Q = (function () {
				function r(t, e) {
					...
					;(this.started = !1),
						...
						this.oscillator.frequency.setValueAtTime(this.f, p.audiocontext.currentTime),
						(this.output = p.audiocontext.createGain()),
						(this._freqMods = []),
					...
					(function (t, e, n) {
					...
					})(r, [
						{
							...
							value: function (t, e) {
								...
								if (!this.started) {
									...
									for (var o in (this.oscillator && (this.oscillator.disconnect(), delete this.oscillator),
									(this.oscillator = p.audiocontext.createOscillator()),
									...
									this._freqMods))
										void 0 !== this._freqMods[o].connect && this._freqMods[o].connect(this.oscillator.frequency)
									this.started = !0
								}
							},
						},
							...
							value: function (t, e, n) {
								...
								if ('number' != typeof t || isNaN(t)) {
									...
									0 === i
										...
										: 0 < t
										? this.oscillator.frequency.exponentialRampToValueAtTime(t, r + i + o)
										: this.oscillator.frequency.linearRampToValueAtTime(t, r + i + o),
						...
						},
						{
							...
							value: function (t, e, n, i) {
								...
								o =
									4 === arguments.length
										? ((r = p5.prototype.map(n, t, e, 0, 1) - 0.5), p5.prototype.map(i, t, e, 0, 1) - 0.5)
										: ((r = t), e)
								var s = new G.a(r, o)
		...
		;(p5.Envelope = function (t, e, n, i, r, o) {
			...
			(p5.Envelope.prototype._init = function () {
				var t = p.audiocontext.currentTime
				this.control.setTargetAtTime(1e-5, t, 0.001), this._setRampAD(this.aTime, this.dTime)
			}),
			...
			(p5.Envelope.prototype.setADSR = function (t, e, n, i) {
				;(this.aTime = t),
					(this.dTime = e || 0),
					(this.sPercent = n || 0),
					(this.dLevel = void 0 !== n ? n * (this.aLevel - this.rLevel) + this.rLevel : 0),
					(this.rTime = i || 0),
					this._setRampAD(t, e)
			}),
			...
			(p5.Envelope.prototype.triggerAttack = function (t, e) {
				...
				!0 === this.isExponential
					...
					(n += this.aTime),
					!0 === this.isExponential
						? (this.control.exponentialRampToValueAtTime(this.checkExpInput(this.aLevel), n),
					...
					(n += this.dTime),
					!0 === this.isExponential
						? (this.control.exponentialRampToValueAtTime(this.checkExpInput(this.dLevel), n),
						  (i = this.checkExpInput(this.control.getValueAtTime(n))),
						  this.control.cancelScheduledValues(n),
						  this.control.exponentialRampToValueAtTime(i, n))
			...
			(p5.Envelope.prototype.triggerRelease = function (t, e) {
				if (this.wasTriggered) {
					...
					!0 === this.isExponential
						...
						(n += this.rTime),
						!0 === this.isExponential
							? (this.control.exponentialRampToValueAtTime(this.checkExpInput(this.rLevel), n),
							  (i = this.checkExpInput(this.control.getValueAtTime(n))),
							  this.control.cancelScheduledValues(n),
							  this.control.exponentialRampToValueAtTime(i, n))
			...
			(p5.Envelope.prototype.ramp = function (t, e, n, i) {
				...
				a < o
					? (this.control.setTargetAtTime(o, r, this._rampAttackTC), (r += this._rampAttackTime))
					: o < a && (this.control.setTargetAtTime(o, r, this._rampDecayTC), (r += this._rampDecayTime)),
					void 0 !== s &&
						(o < s
			...
			(p5.Envelope.prototype.connect = function (t) {
				;((this.connection = t) instanceof p5.Oscillator ||
					...
					(t = t.output.gain),
					t instanceof AudioParam && t.setValueAtTime(0, p.audiocontext.currentTime),
					this.output.connect(t)
			}),
		...
		function wt() {
			for (
				var t = p.audiocontext, e = t.createBuffer(1, 2048, t.sampleRate), n = e.getChannelData(0), i = 0;
				i < 2048;
				i++
			)
				n[i] = 1
							...
							if (!this.started) {
								...
								;(this.oscillator = p.audiocontext.createOscillator()),
									...
									void 0 !== this.mods &&
										...
										(this.mods.frequency.connect(this.freqNode[0]), this.mods.frequency.connect(this.freqNode[1])),
									(this.started = !0),
									(this.osc2.started = !0)
							}
						},
						...
						value: function (t, e, n) {
							...
							if ('number' == typeof t) {
								...
								this.oscillator.frequency.cancelScheduledValues(o),
									...
									this.osc2.oscillator.frequency.exponentialRampToValueAtTime(t, r + i + o),
		...
		var kt = (function () {
				function e(t) {
					!(function (t, e) {
						...
						(window.MediaStreamTrack && window.navigator.mediaDevices && window.navigator.mediaDevices.getUserMedia) ||
							(t ? t() : window.alert('This browser does not support MediaStreamTrack and mediaDevices')),
						p.soundArray.push(this)
				}
				return (
					(function (t, e, n) {
					...
					})(e, [
						{
							...
							value: function (e, n) {
								...
								var t = p.inputSources[i.currentSource],
									r = { audio: { sampleRate: p.audiocontext.sampleRate, echoCancellation: !1 } }
								p.inputSources[this.currentSource] && (r.audio.deviceId = t.deviceId),
									window.navigator.mediaDevices
										.getUserMedia(r)
										.then(function (t) {
											;(i.stream = t),
												(i.enabled = !0),
												(i.mediaStream = p.audiocontext.createMediaStreamSource(t)),
						...
						},
						{
							...
							value: function (t, e) {
								if (e) {
									...
									this.output.gain.cancelScheduledValues(p.audiocontext.currentTime),
										this.output.gain.setValueAtTime(i, p.audiocontext.currentTime),
										this.output.gain.linearRampToValueAtTime(t, n + p.audiocontext.currentTime)
								} else
									this.output.gain.cancelScheduledValues(p.audiocontext.currentTime),
										this.output.gain.setValueAtTime(t, p.audiocontext.currentTime)
							},
						},
						{
							key: 'getSources',
						...
						},
						{
							key: 'setSource',
							value: function (t) {
								0 < p.inputSources.length && t < p.inputSources.length && (this.currentSource = t),
		...
		var Ft = (function () {
				function n(t) {
					...
					return (
						qt(this, n),
						((e = Nt(this, Vt(n).call(this))).biquad = e.ac.createBiquadFilter()),
						...
						},
						{
							...
							value: function (t, e) {
								...
								return (
									t <= 0 && (t = 1),
									'number' == typeof t
										? (this.biquad.frequency.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
										  this.biquad.frequency.exponentialRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
								...
								return (
									'number' == typeof t
										? ((this.biquad.Q.value = t),
										  this.biquad.Q.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
										  this.biquad.Q.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
								...
								return (
									'number' == typeof t
										? ((this.biquad.gain.value = t),
										  this.biquad.gain.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
										  this.biquad.gain.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
				...
				for (var o = 0; o < t; o++)
					(r =
						o === t - 1
							...
							: 0 === o
							? ((i = 100), 0.1)
							: ((i = 1 === o ? (3 === t ? 360 * n : 360) : e.bands[o - 1].freq() * n), 1)),
						(e.bands[o] = e._newBand(i, r)),
						0 < o ? e.bands[o - 1].connect(e.bands[o].biquad) : e.input.connect(e.bands[o].biquad)
						...
						value: function () {
							if (arguments.length === 2 * this.bands.length)
								for (var t = 0; t < arguments.length; t += 2)
									this.bands[t / 2].freq(arguments[t]), this.bands[t / 2].gain(arguments[t + 1])
						},
					},
					{
						key: '_newBand',
					...
					},
					{
						...
						value: function (t, e, n, i) {
							return (
								...
								this.positionY(e, i),
								this.positionZ(n, i),
								[this.listener.positionX.value, this.listener.positionY.value, this.listener.positionZ.value]
							)
						},
					},
					{
							...
							return (
								'number' == typeof t
									? ((this.listener.positionX.value = t),
									  this.listener.positionX.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.listener.positionX.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.listener.positionY.value = t),
									  this.listener.positionY.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.listener.positionY.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.listener.positionZ.value = t),
									  this.listener.positionZ.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.listener.positionZ.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
					...
					},
					{
						...
						value: function (t, e, n, i) {
							return (
								...
								this.forwardY(e, i),
								this.forwardZ(n, i),
								[this.listener.forwardX, this.listener.forwardY, this.listener.forwardZ]
							)
						},
					},
					{
							...
							return (
								'number' == typeof t
									? ((this.listener.forwardX.value = t),
									  this.listener.forwardX.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.listener.forwardX.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.listener.forwardY.value = t),
									  this.listener.forwardY.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.listener.forwardY.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.listener.forwardZ.value = t),
									  this.listener.forwardZ.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.listener.forwardZ.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.listener.upX.value = t),
									  this.listener.upX.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.listener.upX.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.listener.upY.value = t),
									  this.listener.upY.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.listener.upY.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.listener.upZ.value = t),
									  this.listener.upZ.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.listener.upZ.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
					...
					},
					{
						...
						value: function (t, e, n, i) {
							return (
								...
								this.positionY(e, i),
								this.positionZ(n, i),
								[this.panner.positionX.value, this.panner.positionY.value, this.panner.positionZ.value]
							)
						},
					},
					{
							...
							return (
								'number' == typeof t
									? ((this.panner.positionX.value = t),
									  this.panner.positionX.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.panner.positionX.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.panner.positionY.value = t),
									  this.panner.positionY.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.panner.positionY.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.panner.positionZ.value = t),
									  this.panner.positionZ.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.panner.positionZ.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
					...
					},
					{
						...
						value: function (t, e, n, i) {
							return (
								...
								this.orientY(e, i),
								this.orientZ(n, i),
								[this.panner.orientationX.value, this.panner.orientationY.value, this.panner.orientationZ.value]
							)
						},
					},
					{
							...
							return (
								'number' == typeof t
									? ((this.panner.orientationX.value = t),
									  this.panner.orientationX.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.panner.orientationX.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.panner.orientationY.value = t),
									  this.panner.orientationY.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.panner.orientationY.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.panner.orientationZ.value = t),
									  this.panner.orientationZ.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.panner.orientationZ.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
		...
		var ve = (function () {
			function e() {
				...
				return (
					...
					((t = fe(this, ye(e).call(this)))._split = t.ac.createChannelSplitter(2)),
					...
					t._rightFilter.biquad.frequency.setValueAtTime(1200, t.ac.currentTime),
			...
			return (
				...
				(function (t, e, n) {
					...
					},
					{
						...
						value: function (t) {
							'number' != typeof t
								? (t.connect(this.leftDelay.delayTime), t.connect(this.rightDelay.delayTime))
				...
				function r(t, e, n) {
					...
					return (
						...
						t
							...
							: ((i._seconds = 3), (i._decay = 2), (i._reverse = !1), i._buildImpulse()),
						(i.impulses = []),
						(i.set = null),
						i
					)
				...
				return (
					...
					Te(r, [
						...
						},
						{
							...
							value: function (t) {
								if (
									('number' == typeof t && t < this.impulses.length && this._setBuffer(this.impulses[t].audioBuffer),
									'string' == typeof t)
								)
						...
						},
						{
							key: 'dispose',
							value: function () {
								for (var t in (xe(Se(r.prototype), 'dispose', this).call(this), this.impulses))
				...
				(function (t, e, n) {
					...
					},
					{
						...
						value: function (t, e) {
							...
							;(this.tatumTime = i),
								this.clock.frequency.setValueAtTime(this.clock.frequency.value, r),
						...
						},
						{
							...
							value: function (t) {
								this.partStep < this.length - 1
									...
									: this.looping || this.partStep !== this.length - 1 || this.onended()
							},
						},
						{
							key: 'onStep',
				...
				return (
					Be(n, [
						...
						},
						{
							key: 'resetPart',
							value: function (t) {
								for (var e in (this.parts[t].stop(), (this.parts[t].partStep = 0), this.parts[t].phrases))
		...
		function Ie(t) {
			t.currentPart++,
				t.currentPart >= t.parts.length
					...
					: ((t.scoreStep = 0), t.parts[t.currentPart - 1].stop(), t.parts[t.currentPart].start())
		}
		function Ue(t, e) {
			for (var n = 0; n < e.length; n++) {
				var i = e[n]
						...
						value: function () {
							return 'number' == typeof this._interval
								...
								? ((this.musicalTimeMode = !0),
								  (this._bpm / 60 / this._convertNotation(this._interval)) * (this._timeSignature / 4))
								: void 0
						},
					},
					{
		...
		var He = (function () {
			function e() {
				...
				return (
					...
					((t = We(this, Xe(e).call(this))).compressor = t.ac.createDynamicsCompressor()),
							...
							return (
								'number' == typeof t
									? ((this.compressor.attack.value = t),
									  this.compressor.attack.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.compressor.attack.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.compressor.knee.value = t),
									  this.compressor.knee.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.compressor.knee.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.compressor.ratio.value = t),
									  this.compressor.ratio.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.compressor.ratio.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.compressor.threshold.value = t),
									  this.compressor.threshold.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.compressor.threshold.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
							...
							return (
								'number' == typeof t
									? ((this.compressor.release.value = t),
									  this.compressor.release.cancelScheduledValues(this.ac.currentTime + 0.01 + n),
									  this.compressor.release.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
									: 'undefined' != typeof number && t.connect(this.compressor.release),
							...
							e > this.cutoff && e > this.threshold && 0 < e - this.penergy
								...
								: ((this.isDetected = !1),
								  this.framesSinceLastPeak <= this.framesPerPeak
										...
										: ((this.cutoff *= this.decayRate), (this.cutoff = Math.max(this.cutoff, this.threshold)))),
								(this.currentValue = e),
								(this.penergy = e)
						},
					},
					...
					(function (t, e, n) {
						...
						},
						{
							...
							value: function (e, t, n) {
								this._workletNode.port.postMessage({ name: 'start', duration: t }),
									e && n
		...
		function un(t) {
			for (
				var e, n = 'number' == typeof t ? t : 50, i = new Float32Array(44100), r = Math.PI / 180, o = 0;
				o < 44100;
				++o
			)
				(e = (2 * o) / 44100 - 1), (i[o] = ((3 + n) * e * 20 * r) / (Math.PI + n * Math.abs(e)))
			return i
		}
		var cn = (function () {
			function r(t, e) {
			...
			return (
				...
				(function (t, e, n) {
				...
				})(e, [
					{
						key: 'play',
						value: function (t, e, n, i) {
							this.triggerAttack(t, e, ~~n), this.triggerRelease(~~n + (i || 0.15))
						},
					},
					{
						key: 'triggerAttack',
				...
				})(r, [
					{
						...
						value: function (t, e) {
							if (
								...
								!1 === this.isDetected && this.energy - this.penergy > this.treshold)
							) {
					...
					},
					{
						...
						value: function (t, e, n) {
							var i,
								...
								s = h(t),
								a = e || 0.1
							this.notes[s] && null !== this.notes[s].getValueAtTime(o) && this.noteRelease(s, 0),
								this._voicesInUse.getValueAtTime(o) < this.maxVoices
									? (i = Math.max(~~this._voicesInUse.getValueAtTime(o), 0))
									: ((i = this._oldest),
									  (oldestNote = l(this.audiovoices[this._oldest].oscillator.freq().value)),
							...
							if (t) {
								...
								if (this.notes[o] && null !== this.notes[o].getValueAtTime(r)) {
									...
									this._voicesInUse.setValueAtTime(s - 1, r),
										...
										this.audiovoices[this.notes[o].getValueAtTime(r)].triggerRelease(i),
			...
			(p5.prototype._mathChain = function (t, e, n, i, r) {
				for (var o in t.mathOps)
					t.mathOps[o] instanceof r &&
						(t.mathOps[o].dispose(), (n = o) < t.mathOps.length - 1 && (i = t.mathOps[o + 1]))
